...
import { Grid, Typography, Button, Card, CardHeader, CardContent, CardActions, IconButton, TextField } from '@material-ui/core';
...
export default function Notice() {
  ...
  return (
    <Grid container spacing={3}>
      ...
      <Grid item xs={12}>
        <Button variant="contained" color="primary" size="large" startIcon={<DoneIcon />}>
          올리기
        </Button>
      </Grid>
      <Grid item xs={12}>
